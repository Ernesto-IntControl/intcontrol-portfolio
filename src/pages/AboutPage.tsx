        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start mb-24">
          ...
          >
            ...
            <div className="space-y-6 text-slate-600 text-lg leading-relaxed">
              ...
              <p>
                En tant que cofondateur d'Intglobal Services, je travaille sur des projets innovants qui transforment les idées en réalités numériques tangibles, tout en maintenant les plus hauts standards de qualité et de sécurité.
              </p>
            </div>
