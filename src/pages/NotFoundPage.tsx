...
export default function NotFoundPage() {
  return (
    <div className="min-h-screen flex items-center justify-center pt-32 pb-24 px-6 relative overflow-hidden">
      ...
      {/* Background elements */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-brand-teal/5 rounded-full blur-[120px] -z-10" />
      ...
      <div className="text-center max-w-lg">
        ...
        >
          <h1 className="text-9xl font-extrabold text-brand-dark opacity-10 mb-[-2rem]">404</h1>
          <h2 className="text-4xl font-bold mb-6 text-brand-dark">Oups ! Page égarée</h2>
